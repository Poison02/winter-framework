package cdu.zch.winter.context;

import cdu.zch.winter.annotation.*;
import cdu.zch.winter.exception.BeanCreationException;
import cdu.zch.winter.exception.BeanDefinitionException;
import cdu.zch.winter.exception.BeanNotOfRequiredTypeException;
import cdu.zch.winter.exception.NoUniqueBeanDefinitionException;
import cdu.zch.winter.io.PropertyResolver;
import cdu.zch.winter.io.ResourceResolver;
import cdu.zch.winter.utils.ClassUtils;
...
public class AnnotationConfigApplicationContext {
    ...
    Map<String, BeanDefinition> createBeanDefinitions(Set<String> classNameSet) {
        ...
        for (String className : classNameSet) {
            ...
            if (clazz.isAnnotation() || clazz.isEnum() || clazz.isInstance() || clazz.isRecord()) {
                continue;
            }
            // 是否标注@Component
